...
from laneFollower import laneFollower as lf
...
class obstacleAvoidance(object):
    ...
    def avoidStationaryObstacles(self, speed):
        ...
        while True:
            ...
            if abs(servo_pos) > 25:
            #if abs(distance - old_distance) < 2:
                    self.bot.setServoPosition(0)
                    obstacleSteering
